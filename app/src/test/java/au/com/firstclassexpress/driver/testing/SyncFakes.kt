 ...
 * with no endpoint configured the real code path is [au.com.firstclassexpress.driver.domain.sync.UnconfiguredSyncTransport],
...
class FakeSyncTransport(
    ...
    override suspend fun sendIncident(
        idempotencyKey: String,
        payload: au.com.firstclassexpress.driver.data.remote.dto.IncidentSyncDto
    ) = next(idempotencyKey)

    override suspend fun sendPodCompletion(
        idempotencyKey: String,
        payload: au.com.firstclassexpress.driver.data.remote.dto.PodCompletionSyncDto
    ) = next(idempotencyKey)

...
import au.com.firstclassexpress.driver.data.remote.dto.RemoteJobListDto
...
interface TmsApi {
     ...
     * [au.com.firstclassexpress.driver.data.remote.RetrofitSyncTransport] changes: the processor asks the transport to
    ...
    suspend fun postIncident(
        @Header(IDEMPOTENCY_HEADER) idempotencyKey: String,
        @Body body: au.com.firstclassexpress.driver.data.remote.dto.IncidentSyncDto
    ): Response<Unit>

    @POST("v1/driver/jobs/{jobId}/pod")
    suspend fun postPodCompletion(
        @Header(IDEMPOTENCY_HEADER) idempotencyKey: String,
        @Path("jobId") jobId: String,
        @Body body: au.com.firstclassexpress.driver.data.remote.dto.PodCompletionSyncDto
    ): Response<Unit>

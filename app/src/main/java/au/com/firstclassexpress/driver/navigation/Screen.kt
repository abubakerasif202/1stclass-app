...
sealed class Screen(val route: String) {
     ...
     */
    object ReportIncident : Screen("report_incident?jobId={jobId}") {
        fun createRoute(jobId: String? = null) = if (jobId != null) "report_incident?jobId=$jobId" else "report_incident"
    }
